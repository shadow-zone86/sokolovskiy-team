...
- **`/`** (Главная) — одностраничный лендинг: герой, о себе, навыки, направления, в цифрах, портфолио, контакты. Боковая навигация по секциям. Блок «О себе» — карьерный путь (с 2012): ГХК, Системы корпоративной аналитики, ЕРЦ ЖКХ; кратко про спорт и образ жизни. Кнопка «Заказать консультацию» в хедере открывает почту (`consultUrl` в конфиге).
